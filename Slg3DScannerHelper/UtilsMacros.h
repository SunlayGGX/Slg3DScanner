...
#define ERROR_CODE_LOCATION_INFO_WITH_LINE(line)                    "FILE : " __FILE__ " , LINE : " STRINGIFY(line)
#define ERROR_CODE_LOCATION_INFO_WITH_LINE_AND_FUNCTION_NAME(line)  "FUNCTION : " __FUNCTION__ " , " ERROR_CODE_LOCATION_INFO_WITH_LINE(line) 


#define ERROR_CODE_LOCATION_INFO                        ERROR_CODE_LOCATION_INFO_WITH_LINE(__LINE__)
#define ERROR_CODE_LOCATION_WITH_FUNCTION_NAME_INFO     ERROR_CODE_LOCATION_INFO_WITH_LINE_AND_FUNCTION_NAME(__LINE__)

#define NORMALIZE_STATIC_ASSERT_MESSAGE_OUTSIDE_FUNCTION(Message)   "STATIC ASSERT ERROR :  " ERROR_CODE_LOCATION_INFO " , ERROR INFO : " Message
#define NORMALIZE_STATIC_ASSERT_MESSAGE_INSIDE_FUNCTION(Message)    "STATIC ASSERT ERROR :  " ERROR_CODE_LOCATION_WITH_FUNCTION_NAME_INFO " , ERROR INFO : " Message
