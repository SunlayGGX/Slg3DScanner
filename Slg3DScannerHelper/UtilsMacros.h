...
#define SLG_NORMALIZE_EXCEPTION_MESSAGE(Message)    "ERROR :  " SLG_ERROR_CODE_LOCATION_WITH_FUNCTION_NAME_INFO " , ERROR INFO : " Message
#define SLG_NORMALIZE_EXCEPTION_STRING_MESSAGE(Message)    (SLG_NORMALIZE_EXCEPTION_MESSAGE(+ Message)).c_str()
